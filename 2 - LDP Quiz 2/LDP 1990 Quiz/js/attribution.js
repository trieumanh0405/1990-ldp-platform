(function () {
  ...
  var STORAGE_KEY = "lp1990_quiz_attribution_v1";
  ...
  function safeParse(value) {
    try { return JSON.parse(value || "null") || {}; } catch (err) { return {}; }
  }
  ...
  function collect() {
    ...
    if (!data.fbc && data.fbclid) data.fbc = "fb.1." + data.capturedAt + "." + data.fbclid;
    return data;
  }
